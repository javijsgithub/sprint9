    ...
    return (
      <div className='container-welcomeScreen'>
        ...
        <hr></hr>
          ...
          <p className="welcome-description">
            Navega libremente por el listado de artistas para ver sus tarjetas de perfil. Para optimizar tu búsqueda y ganar tiempo, puedes filtrar los perfiles por instrumento y ciudad, lo que te permitirá encontrar músicos que se ajusten específicamente a tus necesidades y ubicación. <br/><br/> Si decides registrarte, al iniciar sesión podrás acceder a funciones adicionales como ver los perfiles de los artistas con una descripción mas completa, ver sus videos y enviarles mensajes directos para iniciar una colaboración. <br/><br/>¡Únete a nuestra comunidad y comienza a crear música juntos!
          </p>
